...
public class JSONTest {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        System.out.println(MD5_32bit("20180416n*#mG&bsGpER3Xmg"));
        System.out.println(MD5_32bit1("abc123"));
        System.out.println(MD5_32bit2("abc123"));
        System.out.println(MD5_64bit("abc123"));
    }
}
